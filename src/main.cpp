...
uint256 hashGenesisBlock("0xd9c9db7ee5066c581f1ee276c23df40b3f6dfb0a39413d5a1c78c564e01cdd0f");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // IPEx: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "IPEx Signed Message:\n";
...
{
    // IPEx: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // IPEx: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // IPEx: 3.5 days
static const int64 nTargetSpacing = 150; // IPEx: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // IPEx: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // IPEx: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // IPEx: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd19a8aa9fe562513ed815b200a9b0da1626bc2ae83fffee58d4d505b54928025");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("4da2409a114700351b9f664831241d304a394c82d0476299c950b7022bf09d47d572f75279f64169dc465abab656f439de513ad0519170d353490d8fdc43564c4b") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1653679846;
        block.nBits    = 504365644;
        block.nNonce   = 683774103;

        if (fTestNet)
        {
            block.nTime    = 1653679846;
            block.nNonce   = 4054513971;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x501e6ffaf1b95a62997b97803f77d95f4ea8d2b1deb562af095881c811e5ff35"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // IPEx: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("IPExMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("IPExMiner : ProcessBlock, block not accepted");
    }
